...
function onDeviceReady() {
    ...
    push.on('registration', function(data) {
        ...
        $.ajax({
            url: "http://24medsonline.com/demo1/respicon_app/respicon_admin/index.php/api/addPush",
            type: 'POST',
            dataType: 'JSON',
...
var base_url = 'http://24medsonline.com/demo1/respicon_app/respicon_admin/index.php/api/';
var base_img_url = 'http://24medsonline.com/demo1/respicon_app/respicon_admin/assets/uploads/profile_pic/';
var app_history = []; 
